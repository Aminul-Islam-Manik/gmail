...
const Yellow = ({toggleVisibility}) => {
    return (
        <div className='nav-left'>
            ...
            <div onClick={()=>toggleVisibility()} className='flex'>
